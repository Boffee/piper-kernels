...
def test_fullgraph_compiled_module_uses_live_weight_and_activation_scale(device, autocast):
    ...
    with torch.no_grad(), torch.autocast(device, dtype=torch.float16, enabled=autocast):
