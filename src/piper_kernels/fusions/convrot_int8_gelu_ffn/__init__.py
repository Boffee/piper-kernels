"""Chunked ConvRot INT8 GELU feed-forward fusion."""
...
def convrot_int8_gelu_ffn_compile_options(
    ...
    """Lazily install chunked GELU FFN and ordinary ConvRot INT8 optimization."""
    from ._compile import (  # noqa: PLC0415 - keep compiler integration lazy
        convrot_int8_gelu_ffn_compile_options as compile_options,
    )
