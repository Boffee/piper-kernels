...
@triton.jit
def _quantize_query_per_thread_kernel(
    query_ptr,
    output_ptr,
    scale_ptr,
    query_length,
...
@triton.jit
def _quantize_key_per_thread_kernel(
    key_ptr,
    mean_ptr,
    output_ptr,
    scale_ptr,
...
def _run_sage_attention_2pp(
    ...
    *,
    ...
    if qk_per_warp:
        ...
        _quantize_query_per_thread_kernel[query_grid](
            query,
            query_int8,
            query_scale,
            query_length,
        ...
        _quantize_key_per_thread_kernel[key_grid](
            key,
            key_mean,
            key_int8,
            key_scale,
