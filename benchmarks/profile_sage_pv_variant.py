...
def _parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "int8-log-split-scaled-fp16-numerator-unmasked-native-descriptor",
            ...
            "int8-log-split-scale-forward-fp16-pv-scale-scaled-fp16-numerator-unmasked-native-descriptor",
            ...
            "int8-log-split-scale-forward-no-pv-scale-scaled-fp16-numerator-unmasked-native-descriptor",
            "int8-log-split-scale-forward-no-log-shift-precomputed-pv-scale-scaled-fp16-numerator-unmasked-native-descriptor",
            ...
            "int8-log-split-narrow-denom-scaled-fp16-numerator-unmasked-native-descriptor",
...
def main(argv: Sequence[str] | None = None) -> None:  # noqa: PLR0915
    ...
    if args.variant.startswith("fp8"):
        ...
        launch = _log_int8_launcher(
            ...
            omit_log_scale_shift="no-log-shift" in args.variant,
